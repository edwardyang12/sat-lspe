...
from train_graph_regression import train_epoch_sparse as train_epoch, evaluate_network_sparse as evaluate_network
from nets.load_net import gnn_model
from data.molecules import MoleculeDatasetDGL, MoleculeDGL, MoleculeDataset
...
def train_val_pipeline(MODEL_NAME, dataset, params, net_params, dirs):
    ...
    if net_params['pe_init'] == 'rand_walk' and MODEL_NAME != 'SAT':
        ...
        from plot_util import plot_graph_eigvec
...
def main():    
    ...
    parser.add_argument('--se', help="Please give a value for se")
    ...
    if args.se is not None:
        net_params['se'] = args.se
    if args.gnn_type is not None:
        net_params['gnn_type'] = args.gnn_type
